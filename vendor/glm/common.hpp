...
/// @tparam L Integer between 1 and 4 included that qualify the dimension of the
/// vector
/// @tparam T Floating-point scalar types, include glm/gtc/integer for integer
...
/// specification, section 8.3 Common Functions</a>
template <length_t L, typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR vec<L, T, Q> clamp(vec<L, T, Q> const& x, T minVal,
                                               T maxVal);
...
GLM_FUNC_DECL GLM_CONSTEXPR vec<L, T, Q> mix(vec<L, T, Q> const& x,
                                             vec<L, T, Q> const& y,
                                             vec<L, U, Q> const& a);

template <length_t L, typename T, typename U, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR vec<L, T, Q> mix(vec<L, T, Q> const& x,
                                             vec<L, T, Q> const& y, U a);
...
/// specification, section 8.3 Common Functions</a>
template <length_t L, typename T, qualifier Q>
GLM_FUNC_DECL vec<L, T, Q> step(vec<L, T, Q> const& edge,
                                vec<L, T, Q> const& x);
...
template <length_t L, typename T, qualifier Q>
GLM_FUNC_DECL vec<L, T, Q> smoothstep(vec<L, T, Q> const& edge0,
...
template <length_t L, typename T, qualifier Q>
GLM_FUNC_DECL vec<L, T, Q> ldexp(vec<L, T, Q> const&   v,
